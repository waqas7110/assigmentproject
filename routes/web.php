...
Route::group(['middleware' => 'auth'], function () {
    // Show user profile
    Route::get('profile/show', [RegisterController::class, 'show'])->name('auth.show');

    // Edit user profile
    Route::get('profile/{id}/edit', [RegisterController::class, 'edit'])->name('auth.edit');

    // Update user profile
    Route::put('profile/{id}/update', [RegisterController::class, 'update'])->name('auth.update');
